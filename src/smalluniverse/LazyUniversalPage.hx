...
abstract LazyUniversalPage(Void->UniversalPage<Dynamic, Dynamic, Dynamic>) {
	...
	@:from public static function fromPage<T>(page:UniversalPage<Dynamic, Dynamic, Dynamic>) {
		return new LazyUniversalPage(function() return page);
	}

	@:from public static function fromFn<T>(getPage:Void->UniversalPage<Dynamic, Dynamic, Dynamic>) {
